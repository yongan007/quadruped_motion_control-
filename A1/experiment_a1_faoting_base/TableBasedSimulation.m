...
error = solution_tape(:,1:n)-x_table(1:n,:);


Error_x = solution_tape-x_table';
Max_Error_x = max(abs(Error_x));
...
figure('Color', 'w')
subplot(2, 1, 1)
SRDgraphic_PlotGeneric(time_table_0', x_table(1:n,:)', ...
    'NewFigure', false, ...
...
subplot(2, 1, 2)
SRDgraphic_PlotGeneric(time_table_0', x_table(n:2*n,:)', ...
    'NewFigure', false, ...
    'Title', 'Joint Velocity', ...
    'LableVariable', '\dot{q}');
hold on
plot(time_table_0, solution_tape(:,n:2*n), 'LineWidth', 3)
...
figure('Color', 'w')
subplot(2, 1, 1)
SRDgraphic_PlotGeneric(time_table_0', Error_x, ...
    'NewFigure', false, ...
...
SRDgraphic_PlotGeneric(time_table_0', cost_u', ...
    'NewFigure', true, ...
