...
% % % ;...
con1 =    SymbolicEngine.LinkArray(6).AbsoluteFollower(:);
con2 =    SymbolicEngine.LinkArray(11).AbsoluteFollower(:);
con3 =    SymbolicEngine.LinkArray(16).AbsoluteFollower(:);
con4 =    SymbolicEngine.LinkArray(21).AbsoluteFollower(:); 
...
task1 =    SymbolicEngine.LinkArray(6).AbsoluteFollower(:);
task2 =    SymbolicEngine.LinkArray(11).AbsoluteFollower(:);
task3 =    SymbolicEngine.LinkArray(16).AbsoluteFollower(:);
task4 =    SymbolicEngine.LinkArray(21).AbsoluteFollower(:); 

Task = [task1;task2;task3;task4;CoM];
%%%%%%%%%
