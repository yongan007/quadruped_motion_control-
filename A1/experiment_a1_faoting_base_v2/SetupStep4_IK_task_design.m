...
ZeroOrderDerivativeNodes = {IC_Task(1), IC_Task(1);
                            IC_Task(2), IC_Task(2);  
                            IC_Task(3), IC_Task(3);
                            IC_Task(4), IC_Task(4)+0.3;
                            IC_Task(5), IC_Task(5);  
                            IC_Task(6), IC_Task(6)+0.2;
                            IC_Task(7), IC_Task(7);
                            IC_Task(8), IC_Task(8);  
                            IC_Task(9), IC_Task(9);
                            IC_Task(10), IC_Task(10);
                            IC_Task(11), IC_Task(11);  
                            IC_Task(12), IC_Task(12);                          
                            IC_Task(13), IC_Task(13)+0.1;
                            IC_Task(14), IC_Task(14);  
                            IC_Task(15), IC_Task(15)}; 
%exp2
