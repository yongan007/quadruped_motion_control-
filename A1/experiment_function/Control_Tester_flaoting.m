...
function [Max_Error_x,Max_cost_u,cost_qr]=Control_Tester_flaoting(time_table,x_table, K_table, solution_tape,Q,R) 
...
L = legend('${q_{ref1}}$','$q_{ref2}$','$q_{ref3}$',...
    ...
    '${q_{ref13}}$','$q_{ref14}$','$q_{ref15}$',...
    '${q_{ref16}}$','$q_{ref17}$','$q_{ref18}$',...
    '${q_{sol1}}$','$q_{sol2}$','$q_{sol3}$',...
    '${q_{sol4}}$','$q_{sol5}$','$q_{sol6}$',...
    '${q_{sol7}}$','$q_{sol8}$','$q_{sol9}$',...
    '${q_{sol10}}$','$q_{sol11}$','$q_{sol12}$',...
    '${q_{sol13}}$','$q_{sol14}$','$q_{sol15}$',...
    '${q_{sol16}}$','$q_{sol17}$','$q_{sol18}$','interpreter','latex');
L.NumColumns = 11;
L.FontSize = 9;
...
L = legend('$\dot{q}_{ref1}$','$\dot{q}_{ref2}$','$\dot{q}_{ref3}$',...
    ...
    '$\dot{q}_{ref13}$','$\dot{q}_{ref14}$','$\dot{q}_{ref15}$',...
    '$\dot{q}_{ref16}$','$\dot{q}_{ref17}$','$\dot{q}_{ref18}$',...
    '$\dot{q}_{sol1}$','$\dot{q}_{sol2}$','$\dot{q}_{sol3}$',...
    '$\dot{q}_{sol4}$','$\dot{q}_{sol5}$','$\dot{q}_{sol6}$',...
    '$\dot{q}_{sol7}$','$\dot{q}_{sol8}$','$\dot{q}_{sol9}$',...
    '$\dot{q}_{sol10}$','$\dot{q}_{sol11}$','$\dot{q}_{sol12}$',...
    '$\dot{q}_{sol13}$','$\dot{q}_{sol14}$','$\dot{q}_{sol15}$',...
    '$\dot{q}_{sol16}$','$\dot{q}_{sol17}$','$\dot{q}_{sol18}$','interpreter','latex');
L.NumColumns = 11;
L.FontSize = 9;
L.Location = 'southoutside';
grid on; grid minor;
