...
function draw_Animation_iiwa(TimeTable,IK_Table,type_pose,Task_params,Cube,Handler_IK_Solution,Handler_IK_Model,DrawRobot_Type)
...
visuals_config.ViewAngle =  [-165,8];
visuals_config.AxisLimits = [-0.5;0.6;-0.2;0.8;-0.2;1];
