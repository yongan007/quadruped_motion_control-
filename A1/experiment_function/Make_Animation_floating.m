...
function Make_Animation_floating(TimeTable,IK_Table,Task_params,Cube,Handler_IK_Solution,Handler_IK_Model,DrawRobot_Type)
...
SRD__animate__position_floating('Handler_Simulation', Handler_Simulation, ...
