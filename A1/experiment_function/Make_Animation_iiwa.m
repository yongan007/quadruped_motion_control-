...
function Make_Animation_iiwa(TimeTable,IK_Table,Task_params,Cube,Handler_IK_Solution,Handler_IK_Model,DrawRobot_Type)
...
SRD__animate__position_iiwa('Handler_Simulation', Handler_Simulation, ...
