...
function Handler_IK_Solution = Get_IK_task_line_flaoting(varargin)
...
ZeroOrderDerivativeNodes = {IC_Task(1), Goal_task(1);
                            ...
                            IC_Task(4), Goal_task(4);
                            IC_Task(5), Goal_task(5);  
                            IC_Task(6), Goal_task(6);
                            IC_Task(7), Goal_task(7);
                            IC_Task(8), Goal_task(8);  
                            IC_Task(9), Goal_task(9);
                            IC_Task(10), Goal_task(10);
                            IC_Task(11), Goal_task(11);  
                            IC_Task(12), Goal_task(12);                          
                            IC_Task(13), Goal_task(13);
                            IC_Task(14), Goal_task(14);  
                            IC_Task(15), Goal_task(15)};  
