...
function [Max_Error_x,Max_cost_u,cost_qr] = Get_Simulation_Cost(varargin)

Parser = inputParser;
Parser.FunctionName = 'Get_Simulation_Cost';
...
if Parser.Results.Enable_tester  
    [Max_Error_x,Max_cost_u,cost_qr] = Control_Tester(time_table_0,x_table, K_table, solution_tape,Q,R);
else 
    [Max_Error_x,Max_cost_u,cost_qr]=Calculate_Cost(time_table,x_table, K_table, solution_tape,Q,R);
end
