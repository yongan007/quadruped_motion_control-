...
% InitialPosition = [0, pi/6, pi/6, 0, 0, pi/3, 0, 0, pi/3, 0, 0, pi/3]';
% InitialPosition = [0, pi/8, pi/6, 0, pi/8, pi/6, 0, pi/8, pi/6, 0, pi/8, pi/6]';
% InitialPosition = [0, pi/8, pi/12, 0, pi/8, pi/12, 0, pi/2, -pi/6, 0, pi/2, -pi/6]';

% InitialPosition = [0, pi/2, -pi/6, 0, pi/2, -pi/6,0, pi/8, pi/28, 0, pi/8, pi/28]';
InitialPosition = [0, pi/3, -pi/6, 0, pi/3, -pi/6,0, pi/4, 0, 0, pi/4, 0]';
