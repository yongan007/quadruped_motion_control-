function SRD__animate__position_floating(varargin)
...
visuals_config.AxisLimits = [-0.5;0.5;-0.5;0.5;-0.4;0.5];
view([-10,20]);
...
task_traj = zeros(15,length(Parser.Results.IK_Table));
...
plot3(task_traj(13,:),task_traj(14,:),task_traj(15,:));
...
%     end
    ...
    view([-7,15]); %restore the user-set view
    axis equal;
    xlabel("x");
    axis(visuals_config.AxisLimits);
