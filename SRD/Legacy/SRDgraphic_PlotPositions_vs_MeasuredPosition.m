...
function SRDgraphic_PlotPositions_vs_MeasuredPosition(SimulationOutput, varargin)
Parser = inputParser;
Parser.FunctionName = 'SRDgraphic_PlotPositions_vs_MeasuredPosition';
...
if NewFigure
    figure_handle = figure('Color', 'w', 'Name', 'Positions vs MeasuredPosition');
end
...
for i = 1:length(Parser.Results.Indeces)
    ...
    labels{j+1} = ['$$\hat q_', num2str(index), '$$'];
end
